...
function setup() {
	...
	Engine.run(engine);
	bob1=Bodies.circle(320,380,20)
	bob2=Bodies.circle(360,380,20)
	bob3=Bodies.circle(400,380,20)
	bob4=Bodies.circle(440,380,20)
	bob5=Bodies.circle(480,380,20)
...
function draw() {
  ...
  ellipse(bob1.position.x,bob2.position.y,20)
